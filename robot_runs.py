...
def run1(): 
    ...
    wheels.stop()
    gyro_abs(92, 40) 
    gear_box.output.run_time(-500, 2000)
    straight_time(200, 2)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
    gear_box.output.run_time(700, 2500)
    wheels.settings(200)
    wheels.straight(-100)
    wheels.curve(40, 50, then=Stop.NONE)
    straight_time(600, 3, -1)
